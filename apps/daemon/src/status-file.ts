...
import { CAPABILITY_AGENT_API_PROTOCOLS, CAPABILITY_AGENT_API_VALIDATION, type SessionInfo } from "@prospero/protocol";
...
export class StatusFile {
  ...
  private write(): void {
    ...
    const snapshot: StatusSnapshot = {
      ...
      capabilities: [CAPABILITY_AGENT_API_PROTOCOLS, CAPABILITY_AGENT_API_VALIDATION],
