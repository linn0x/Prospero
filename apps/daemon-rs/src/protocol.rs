...
pub fn typescript() -> String {
    ...
    let declarations = [
        ...
        crate::agent::MessageCrossModelChild::decl(&config),
        crate::agent::CancelCrossModelChild::decl(&config),
        crate::agent::ScheduleCrossModelCheck::decl(&config),
        crate::agent::CrossModelChildQuery::decl(&config),
        crate::agent::CrossModelChildLogsQuery::decl(&config),
        crate::agent::CrossModelCheck::decl(&config),
        crate::agent::CrossModelChild::decl(&config),
        crate::agent::CrossModelChildPage::decl(&config),
        crate::agent::CrossModelChildLogs::decl(&config),
        crate::agent::CrossModelChildResult::decl(&config),
