CREATE TABLE agent_runs_v21 (
    ...
    agent TEXT NOT NULL CHECK(agent IN ('claude','codex','deepseek')),
...
INSERT INTO agent_runs_v21(session_id,agent,active,approval_policy,turn,native_id,permission_mode,model,effort,account_id,agent_preset)
    SELECT session_id,agent,active,approval_policy,turn,native_id,permission_mode,model,effort,account_id,NULL FROM agent_runs;
