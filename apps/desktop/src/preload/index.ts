...
const api: DesktopApi = {
  ...
  readTimelineChanges: (id, after, requestId) => ipcRenderer.invoke("timeline:changes", id, after, requestId),
  lookupTimeline: (id, ids, requestId) => ipcRenderer.invoke("timeline:lookup", id, ids, requestId),
  readTimelineText: (id, record, query, requestId) => ipcRenderer.invoke("timeline:body", id, record, query, requestId),
