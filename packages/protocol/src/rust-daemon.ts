...
export type DatabaseHealth = { alive: boolean, queueDepth: number, lastError?: string | null, };
export type HealthPersistence = { pty: boolean, structured: boolean, };
export type Health = { apiVersion: number, backend: string, daemonVersion: string, buildId: string, activeRuntimeSessions: number, databaseQueueCapacity: number, database: DatabaseHealth, capabilities: Array<string>, persistence: HealthPersistence, relay?: RelayRuntimeStatus | null, };
...
export type ModelCapabilitySupportValue = "enforced" | "unsupported";
export type ModelCapabilitySupport = { contextWindow?: ModelCapabilitySupportValue | null, maxOutputTokens?: ModelCapabilitySupportValue | null, tools?: ModelCapabilitySupportValue | null, vision?: ModelCapabilitySupportValue | null, reasoning?: ModelCapabilitySupportValue | null, };
...
export type EngineValidationChecks = { runtime: Check, configuration: Check, streaming: Check, tools: Check, };
...
export type ApiEngineValidation = { status: string, checkedAt: number, engine: string, cliVersion?: string | null, checks: EngineValidationChecks, code?: string | null, detail: string, latencyMs?: number, };
export type NativeAccount = { id: string, agent: AgentKind, name: string, managed: boolean, isDefault: boolean, status: AccountStatus, capabilities: AccountCapabilities, apiProfile?: ApiProfile | null, modelSource?: SourceBindingView | null, engine?: string | null, apiValidation?: ApiValidation | null, apiEngineValidation?: ApiEngineValidation | null, modelCapabilitySupport?: ModelCapabilitySupport | null, authMethod?: string | null, detail?: string | null, createdAt: number, updatedAt: number, activeSessions: number, };
export type AccountListResult = { type: string, requestId: string, action: string, ok: boolean, accounts: Array<NativeAccount>, accountId?: string | null, sessionId?: string | null, validation?: ApiValidation | null, engineValidation?: ApiEngineValidation | null, };
