...
export type NativeAccount = { id: string, agent: AgentKind, name: string, managed: boolean, isDefault: boolean, status: AccountStatus, capabilities: AccountCapabilities, apiProfile?: ApiProfile | null, engine?: string | null, apiValidation?: ApiValidation | null, authMethod?: string | null, detail?: string | null, createdAt: number, updatedAt: number, activeSessions: number, };
