...
export type CreateTerminal = { title: string, workspace: string, size: TerminalSize, };
...
export type NativeAccount = { id: string, agent: AgentKind, name: string, managed: boolean, isDefault: boolean, status: AccountStatus, capabilities: AccountCapabilities, authMethod?: string | null, detail?: string | null, createdAt: number, updatedAt: number, activeSessions: number, };
export type AccountListResult = { type: string, requestId: string, action: string, ok: boolean, accounts: Array<NativeAccount>, accountId?: string | null, sessionId?: string | null, };
