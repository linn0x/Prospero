...
export type NativeAccount = { id: string, agent: AgentKind, name: string, managed: boolean, isDefault: boolean, status: AccountStatus, capabilities: AccountCapabilities, apiProfile?: ApiProfile | null, modelSource?: SourceBindingView | null, engine?: string | null, apiValidation?: ApiValidation | null, apiEngineValidation?: ApiEngineValidation | null, authMethod?: string | null, detail?: string | null, createdAt: number, updatedAt: number, activeSessions: number, };
