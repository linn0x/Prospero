...
export type TimelineBody = { "kind": "message", role: MessageRole, finalAnswer: boolean, } | { "kind": "reasoning" } | { "kind": "tool", name: string, state: ToolState, summary: string, } | { "kind": "turn_end", finish: string, } | { "kind": "error" };
