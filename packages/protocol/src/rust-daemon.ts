...
export type Health = { apiVersion: number, backend: string, daemonVersion: string, buildId: string, activeRuntimeSessions: number, databaseQueueCapacity: number, capabilities: Array<string>, persistence: HealthPersistence, relay?: RelayRuntimeStatus | null, };
